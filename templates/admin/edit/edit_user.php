   ...
   <main>
      <div class="path">
         <div class="container">
            ...
            <a href="../admin.php?table=users" class="path_text">Админ панель</a>
            <p class="path_text">&nbsp;<img src="/assets/img/layout/path_arrow.png" alt="" class="path_arrow">&nbsp;</p>
            <a class="path_text_active">Редактировать пользователя</a>
         </div>
      </div>
      <section class="auth">
         <div class="container">
            <h2 class="form_title">Редактировать пользователя</h2>
