...
?>
      ...
      <head>
         ...
         <title>Signing in | NO CAP | Online store for style lovers</title>
   ...
   { ?>
      <main>
         ...
         <section class="auth">
            <div class="container">
               <h2 class="auth_title">Logging in</h2>
               <form class="auth_form" method="post">
                  ...
                  <button class="auth_btn" type="submit" id="submit">Sign in</button>
